...
const GuideInfo = () => {
  ...
  return (
    <section className="grid items-center md:grid-flow-col md:grid-cols-2 gap-4 p-8 -mt-4 rounded-lg shadow-md bg-gradient-to-r from-slate-50 to-slate-200">
      <div className="flex flex-col gap-3 p-6">
        <h2 className="text-xl font-medium">Contribute to our platform</h2>
        <p className="text-3xl lg:text-4xl font-semibold text-slate-600">
          Become a Guide In 3 Easy Steps
        </p>
        ...
        <div className="flex flex-col gap-4 mt-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p>
                Elevate your adventure by sharing your tour location details. Simply fill out our
                form with four captivating photos, location specifics, price and other essential
                details to showcase your tour.
              </p>
            </div>
          </div>
          <div className="flex items-start gap-4">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p>
                Ready to embark on your journey? Once your tour is verified, it goes live, and you
                can start accepting bookings from eager travelers.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="flex flex-col items-center gap-12 mt-6">
        ...
        <Button
          ...
          size="md"
          className="font-medium uppercase bg-gradient-to-r from-green-50 to-lime-400 border-gray-500 rounded-full shadow-md"
        >
          Contribute Tour
        </Button>
      </div>
